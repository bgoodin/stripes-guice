h2. learn about stripes-guice

p. "stripes-guice website":http://bgoodin.github.com/stripes-guice

h2. FOR COLABORATORS - Deploying stripes-guice release
...
p. As of Maven 2.1.0 you can now encrypt your servers passwords.  We highly recommend that you follow this guide [http://maven.apache.org/guides/mini/guide-encryption.html] to set your master password and use it to encrypt your Sonatype password in the next section.
...
bc. mvn -Dusername=[your_scm_username] -Dpassword=[your_scm_password] release:prepare

p. Perform

bc. mvn release:perform -Dgpg.passphrase=thephrase[or enter it interactively]
...
p. if you have made any changes to the flexjson website you can unzip one of the distributions and copy the docs folder up to the sourceforge website

h3. Additional Information

p. Actual preparation for setting up a Sonatype repository for syncing with the Maven Centeral repository. This has already been handled but it is good information in order to undestand the bigger picture.
